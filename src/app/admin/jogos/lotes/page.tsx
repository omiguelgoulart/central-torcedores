...
export default function LotesPorJogoPage() {
    ...
    <div className="space-y-6">
      <AdminBreadcrumb
        items={[
          ...
          { label: "Lotes", href: "/admin/jogos/lotes" },
        ]}
      />

      <div>
        <h1 className="text-3xl font-bold">Lotes por Jogo</h1>
        <p className="text-muted-foreground">
          Selecione um jogo para configurar seus lotes de ingressos.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Clique em um jogo para gerenciar seus lotes.</CardDescription>
        </CardHeader>
          ...
          {jogos.map((jogo) => (
            ...
            >
              ...
              <Button size="sm" asChild>
                <Link href={`/admin/jogos/${jogo.id}?tab=lots`}>
                  Ver Lotes
                </Link>
              </Button>
            </div>
